package com.company.mychecklist.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> urlNotFound(ObjectNotFoundException e, HttpServletRequest httpServletRequest) {
